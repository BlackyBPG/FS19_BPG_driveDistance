...
function BPG_DriveDistance:onDraw(isActiveForInput, isActiveForInputIgnoreSelection, isSelected)
	...
	if self.spec_enterable.isEntered then
		...
		renderText(offsetX-tripWidth+tripVariance,0.014775,spec.textSizeL,tripFront)

		setTextAlignment(RenderText.ALIGN_RIGHT)
		setTextColor(0.9,0.35,0.35,1)
		renderText(offsetX+tripWidth+tripVariance,0.014775,spec.textSizeL,tripBack)

		setTextColor(1,1,1,1)
		renderText(offsetX+tripWidth+tripVariance,0.014775,spec.textSizeL,spec.distanceText)
