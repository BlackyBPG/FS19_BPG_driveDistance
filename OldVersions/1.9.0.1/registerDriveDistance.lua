...
registerDriveDistance.version = "1.9.0.1  -  11.11.2018"
...
if g_specializationManager:getSpecializationByName("BPG_DriveDistance") == nil then
	...
	print(" ++ loading DriveDistance V "..tostring(registerDriveDistance.version).." for "..tostring(numVehT).." motorized Vehicles")
end
